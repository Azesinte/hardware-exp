...
HD_PWD='G:/LAB2/lab2_4_1/lab2_4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_look_ahead_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source carry_look_ahead_adder.tcl -notrace
