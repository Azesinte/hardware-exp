...
HD_PWD='G:/lab8/lab8-3-1/lab8-3-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_3_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab8_3_1.tcl -notrace
