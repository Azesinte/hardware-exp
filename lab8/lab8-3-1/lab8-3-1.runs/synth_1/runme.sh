...
HD_PWD='G:/lab8/lab8-3-1/lab8-3-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_3_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab8_3_1.tcl
